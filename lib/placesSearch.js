...
// Real, named candidates near the destination for the itinerary builder to
// place into the day plan — it only ever uses these, never invents its own.
// maxPrice (Google's own 0-4 price_level scale) restricts to that budget or
// below; omit it to search regardless of price.
export async function searchNearbyPlaces({ lat, lng, type, keyword, maxPrice }, apiKey, { radius = 15000, limit = 20 } = {}) {
