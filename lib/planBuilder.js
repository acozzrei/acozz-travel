...
/**
 * @param {{destinationName: string, dates: string[], restaurants: Array, activities: Array, lodging: Array, partySize: number, flights: object|null}} args
 * @returns proposal object (JSON-safe, no DB writes)
 */
export function buildPlan({ destinationName, dates, restaurants, activities, lodging, partySize = 2, flights = null }) {
